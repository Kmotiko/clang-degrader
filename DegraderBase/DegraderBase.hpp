...
class DegraderBase : public clang::tooling::SourceFileCallbacks{
    public:
         ...
         */
        virtual bool handleBeginSource (clang::CompilerInstance &CI, llvm::StringRef Filename);
        ...
        std::map<std::string, clang::tooling::TranslationUnitReplacements> 
            getTUReplacementsMap(){return this->TUReplacementsMap;}
    ...
    protected:
         ...
         */
        std::map<std::string, clang::tooling::TranslationUnitReplacements> TUReplacementsMap;
