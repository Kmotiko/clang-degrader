 ...
 */
bool DegraderBase::handleBeginSource (clang::CompilerInstance &CI, llvm::StringRef Filename){
 ...
 */
bool DegraderBase::addReplacement(const clang::tooling::Replacement &replacement){
